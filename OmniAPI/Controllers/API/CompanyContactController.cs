...
namespace OmniAPI.Controllers
{
    ...
    public class CompanyContactController : BaseController<CompanyContact>
    {
        public CompanyContactController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
