...
namespace OmniAPI.Controllers
{
    ...
    public class CompanyLanguageController : BaseController<CompanyLanguage>
    {
        public CompanyLanguageController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
