...
namespace OmniAPI.Controllers
{
    ...
    public class UserSettingController : BaseController<UserSetting>
    {
        public UserSettingController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
