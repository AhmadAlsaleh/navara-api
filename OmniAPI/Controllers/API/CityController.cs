...
namespace OmniAPI.Controllers
{
    ...
    public class CityController : BaseController<Country>
    {
        public CityController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
