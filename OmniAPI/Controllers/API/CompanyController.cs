...
namespace OmniAPI.Controllers
{
    ...
    public class CompanyController : BaseController<CompanyContact>
    {
        public CompanyController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
