...
namespace OmniAPI.Controllers
{
    ...
    public class LogEventController : BaseController<LogEvent>
    {
        public LogEventController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
