...
namespace OmniAPI.Controllers
{
    ...
    public class CurrencyLanguageController : BaseController<CurrencyLanguage>
    {
        public CurrencyLanguageController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
