...
namespace OmniAPI.Controllers
{
    ...
    public class SyncTableSettingController : BaseController<SyncTableSetting>
    {
        public SyncTableSettingController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
