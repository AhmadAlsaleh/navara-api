...
namespace OmniAPI.Controllers
{
    ...
    public class SyncHistoryController : BaseController<SyncHistory>
    {
        public SyncHistoryController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
