...
namespace OmniAPI.Controllers
{
    ...
    public class CompanyLogoController : BaseController<CompanyLogo>
    {
        public CompanyLogoController(OmniDbContext context, LogDbContext logContext, UserManager<ApplicationUser> userManager)
